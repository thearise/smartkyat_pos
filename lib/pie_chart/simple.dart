...
class SimplePieChart extends StatelessWidget {
  ...
  static List<charts.Series<LinearSales, String>> _createRandomData() {
    ...
    final data = [
      new LinearSales('Drinks', random.nextInt(100)),
      new LinearSales('Tobacco', random.nextInt(100)),
      new LinearSales('Paints', random.nextInt(100)),
      new LinearSales('Cloths', random.nextInt(100)),
    ];
