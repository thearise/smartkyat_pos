                        ...
                        Container(
                          ...
                          child: IconButton(
                            ...
                            onPressed: () {
                              ...
                              if(pnameCtrl.text.length>0 || mcostCtrl.text.length>0 || msaleCtrl.text.length>0 || munitCtrl.text.length>0 || mnameCtrl.text.length>0 || bcodeCtrl.text.length>0) {
                              ...
                              if (_formKey.currentState!.validate()) {
                                ...
                                FirebaseFirestore.instance
                                  ...
                                  getStoreId().then((String result2) {
                                    ...
                                    FirebaseFirestore.instance
                                        .collection('space').doc('0NHIS0Jbn26wsgCzVBKT').collection('shops').doc(
                                        ...
                                        for(int i = 0; i < assets.length; i++) {
                                          ...
                                          asset.originFile.then((value) async {
                                            addProduct(value!).then((value) {
                                              ...
                                              photoUploaded(assets.length, photoArray);
                                            });
                                          });
                                        }
                                        ...
                                        if(assets.length==0) {
                                          ...
                                          FirebaseFirestore.instance
                                            ...
                                            getStoreId().then((String result2) {
                                              ...
                                              FirebaseFirestore.instance
                                                  .collection('space').doc('0NHIS0Jbn26wsgCzVBKT').collection('shops').doc('PucvhZDuUz3XlkTgzcjb').collection('products')
                                                  .where('prod_name', isEqualTo: prodFieldsValue[0])
                                                  .get()
                                                  .then((QuerySnapshot querySnapshot) async {
                                                querySnapshot.docs.forEach((doc) {
                                                ...
                                                if(prodExist) {
                                                  ...
                                                  CollectionReference shops = FirebaseFirestore.instance.collection('space').doc('0NHIS0Jbn26wsgCzVBKT').collection('shops').doc('PucvhZDuUz3XlkTgzcjb').collection('products');
                                                  return shops
                                                      .add({
...
// ignore: deprecated_member_use
    ...
    var multipartFile = new http.MultipartFile(
        "image", stream, length, filename: Path.basename(imageFile.path));
