                                                            ...
                                                            Padding(
                                                              ...
                                                              child: Column(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    //         onPressed: () async {
                                                                    //         },
                                                                    //         child: Center(child: Text(TtlProdListPrice().replaceAllMapped(RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},'), style: TextStyle(
                                                                    //           fontSize: 18, fontWeight: FontWeight.w500,
                                                                    //         ))),
                                                                    //       ),
                                                                    //     ),
                                                                    ...
                                                                    //         onPressed: () async {
                                                                    //         },
                                                                    //         child: Center(child: Text(int.parse(TtlProdListPrice()).floor().toString(), style: TextStyle(
                                                                    //           fontSize: 18, fontWeight: FontWeight.w500,
                                                                    //         ))),
                                                                    //       ),
                                                                    //     ),
                                            ...
                                            child: Column(
                                              children: [
                                                Container(
                                                  ...
                                                  width: double.infinity,
                                                  child:
                                                   eachProd.length!=0 ? StreamBuilder<
                                                      DocumentSnapshot<
                                                          Map<String,
                                                              dynamic>>>(
                                                      stream: FirebaseFirestore
                                                      ...
                                                      builder:
                                                        ...
                                                        if (snapshot2.hasData) {
                                                          var output2 = snapshot2
                                                              .data!
                                                              .data();
                                                          var prodName = output2?['prod_name'];
                                                          var salePrice = eachProd.split('-')[2];
                                                          return Stack(
                                                            children: [
                                                         Container(
                                                        width: double.infinity,
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        GestureDetector(
                                                                          onTap: () {
                                                                              ...
                                                                              j++)
                                                                              {
                                                                                if( prodList[j].split('-')[0] == eachProd.split('-')[0]){

                                                                                    mystate((){
                                                                                     // eachProd.split('-')[4] = quantity.toString();
                                                                                  eachProd = eachProd.replaceAll(eachProd.split('-')[4] , quantity.toString());
                                                                                  prodList[j]=eachProd;
                                                                                    });
