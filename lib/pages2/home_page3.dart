...
//     for(int i = 0; i < prodList.length; i++) {
//       debugPrint('proddddd ' + prodList[i].toString());
...
//                 prodList[index] = prodList[index].split('^')[0] + '^' + prodListInCartModData[index].split('^')[0] + '^' +
//                     prodList[index].split('^')[2] + '^' + prodList[index].split('^')[3] + '^' + prodList[index].split('^')[4] + '^' + prodList[index].split('^')[5];
//
//
//                 String image = prodListInCartModData[index].split('^')[4];
//                 prodListInd = prodListInd.split('^')[0] + '^' + prodListInCartModData[index].split('^')[0] + '^' +
...
//                         mainName =  prodListInCartModData[index].split('^')[1];
//                         sub1Name = prodListInCartModData[index].split('^')[2];
//                         sub2Name = prodListInCartModData[index].split('^')[3];
...
//
//
//                         productName = prodListInCartModData[index].split('^')[0];
...
//                                       fadeInCurve: Curves.bounceIn,
//                                       fit: BoxFit.cover,) : Image.asset('assets/system/default-product.png', height: 58, width: 58, fit: BoxFit.cover,)),
//                                 title: Text(prodListInCartModData[index].split('^')[0], style: TextStyle(fontWeight: FontWeight.w500, fontSize: 16, height: 0.9),),
//                                 subtitle: Padding(
//                                   padding: const EdgeInsets.only(top: 4.0),
//                                   child: Row(
//                                     children: [
//                                       Text(prodListInCartModData[index].split('^')[indexFromUnit(prodListInd)] + ' ', style: TextStyle(
//                                           fontSize: 12.5, fontWeight: FontWeight.w500, color: Colors.grey, height: 0.9
//                                       )),
//                                       if (prodListInd.split('^')[3] == 'unit_name') Icon( SmartKyat_POS.prodm, size: 17, color: Colors.grey,)
//                                       else if(prodListInd.split('^')[3] == 'sub1_name')Icon(SmartKyat_POS.prods1, size: 17, color: Colors.grey,)
//                                       else Icon(SmartKyat_POS.prods2, size: 17, color: Colors.grey,),
//                                     ],
//                                   ),
//                                 ),
