...
//                                                         //
//                                                         //   debugPrint("SHOP ID " + widget.shopId + ' ' + prodID.split('-')[0]);
...
//                                                         //
//                                                         //     debugPrint("LENGTH " + qsNew.docs.length.toString());
//                                                         //
//                                                         //     qsNew.docs.forEach((doc) {
//                                                         //       dateExist = true;
//                                                         //       dateId = doc.id;
//                                                         //       debugPrint('UNIT ' + doc.id.toString());
//                                                         //     });
//                                                         //
//                                                         //     debugPrint('Unit' + unit + ' ' + now.year.toString() + zeroToTen(now.month.toString()) + zeroToTen(now.day.toString()) + '0' + deviceIdNum);
//                                                         //     debugPrint('dick exist - > ' + dateExist.toString());
...
//                                                         //           .catchError((error) => debugPrint("Failed to update dateexist: $error"));
//                                                         //     }
//                                                         //     else {
...
//                                                                       ),),
//                                                                       Spacer(),
//                                                                       Text('$currencyUnit ' + buyPrice1.replaceAllMapped(RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},'), style:
//                                                                       TextStyle(
//                                                                         fontSize: 15,
//                                                                         fontWeight: FontWeight.w500,
//                                                                         color: Colors.grey,
...
//                                                                       ),),
//                                                                       Spacer(),
//                                                                       Text('$currencyUnit ' + buyPrice2.replaceAllMapped(RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},'), style:
//                                                                       TextStyle(
//                                                                         fontSize: 15,
//                                                                         fontWeight: FontWeight.w500,
//                                                                         color: Colors.grey,
...
//                                                                       ),),
//                                                                       Spacer(),
//                                                                       Text('$currencyUnit ' + buyPrice3.replaceAllMapped(RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},'), style:
//                                                                       TextStyle(
//                                                                         fontSize: 15,
//                                                                         fontWeight: FontWeight.w500,
//                                                                         color: Colors.grey,
