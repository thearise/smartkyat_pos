...
class VersionDetailsView extends StatefulWidget {
  final _callback;
  const VersionDetailsView({Key? key, required this.versionID, required this.idString, required void toggleCoinCallback(String str)}) : _callback = toggleCoinCallback;
