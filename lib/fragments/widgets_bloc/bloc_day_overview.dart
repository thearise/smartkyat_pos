...
class BlocDayOverview extends StatefulWidget {

  const BlocDayOverview({
    Key? key,
  ...
  @override
  _BlocDayOverviewState createState() => _BlocDayOverviewState();
...
class _BlocDayOverviewState extends State<BlocDayOverview> {
  ...
  void initState() {
    ...
    if(widget.isEnglish == true) {
      ...
      setState(() {
        ...
        textSetDiscount = 'အရောင်းအားလုံး လျှော့ငွေ';
      });
    }
  ...
  double realMthSale = 0;
  double realMthUnpaid = 0;
  double realMthRefund = 0;
  double realMthCost = 0;
  double realMthLoss = 0;
  double realMthCapital = 0;
  ...
  double profitBySlide() {
    ...
    if(_sliding == 0) {
      ...
      profit = realMthSale - (realMthCapital);
    }
    ...
    for(int loopOrd = 0; loopOrd < snapshot0.length; loopOrd++) {
      ...
      for(int i = 1; i< 32; i++) {
        if(data[today.year.toString() + zeroToTen(today.month.toString()) + zeroToTen(i.toString()) + 'cash_cust'] != null) {
          realMthSale += data[today.year.toString() + zeroToTen(today.month.toString()) + zeroToTen(i.toString()) + 'cash_cust'];
        }
      }

      for(int i = 1; i< 32; i++) {
        if(data[today.year.toString() + zeroToTen(today.month.toString()) + zeroToTen(i.toString()) + 'capital'] != null) {
          realMthCapital += data[today.year.toString() + zeroToTen(today.month.toString()) + zeroToTen(i.toString()) + 'capital'];
        }
      }

      for(int i = 1; i< 32; i++) {
        if(data[today.year.toString() + zeroToTen(today.month.toString()) + zeroToTen(i.toString()) + 'cash_merc'] != null) {
          realMthCost +=  data[today.year.toString() + zeroToTen(today.month.toString()) + zeroToTen(i.toString()) + 'cash_merc'];
        }
      }

      for(int i = 1; i< 32; i++) {
        if(data[today.year.toString() + zeroToTen(today.month.toString()) + zeroToTen(i.toString()) + 'debt_cust'] != null) {
          realMthUnpaid +=  data[today.year.toString() + zeroToTen(today.month.toString()) + zeroToTen(i.toString()) + 'debt_cust'];
        }
      }

      for(int i = 1; i< 32; i++) {
        if(data[today.year.toString() + zeroToTen(today.month.toString()) + zeroToTen(i.toString()) + 'refu_cust'] != null) {
          realMthRefund +=  data[today.year.toString() + zeroToTen(today.month.toString()) + zeroToTen(i.toString()) + 'refu_cust'];
        }
      }
      ...
      for(int i = 1; i< 32; i++) {
        if(data[today.year.toString() + zeroToTen(today.month.toString()) + zeroToTen(i.toString()) + 'loss_cust'] != null) {
          realMthLoss +=  data[today.year.toString() + zeroToTen(today.month.toString()) + zeroToTen(i.toString()) + 'loss_cust'];
        }
      }
