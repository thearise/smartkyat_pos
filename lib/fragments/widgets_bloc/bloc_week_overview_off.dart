...
class BlocWeekOverviewOff extends StatefulWidget {
  final double? gloBotPadd;
  const BlocWeekOverviewOff({Key? key, this.gloBotPadd,}) : super(key: key);

  @override
  _BlocWeekOverviewOffState createState() => _BlocWeekOverviewOffState();
}

class _BlocWeekOverviewOffState extends State<BlocWeekOverviewOff>
    with TickerProviderStateMixin<BlocWeekOverviewOff>{
              ...
              child:  Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text('textSetSaleSummary WEek', textScaleFactor: 1,
                      style: TextStyle(
                        height: 0.9,
                        letterSpacing: 2,
