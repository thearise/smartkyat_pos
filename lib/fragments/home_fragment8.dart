                                  ...
                                  // displays the index of the current item.
                                    ...
                                    return Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Padding(
                                            padding: const EdgeInsets.only(top: 15.0, bottom: 4.0, left: 15.0, right: 15.0),
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        'Debt to income (MMK)',strutStyle: StrutStyle(
                                                          forceStrutHeight: true,
                                                          height: 1.2
                                                      ),
                                                        style: TextStyle(
                                          ...
                                          Padding(
                                            padding: const EdgeInsets.only(left: 15.0, right: 15.0, bottom: 20.0, top: 5),
                                            child: ButtonTheme(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Row(
                                                    children: [
                                                      ...
                                                      TextStyle(
                                                        fontSize: 16,
                                                        fontWeight: FontWeight.w600, color: Colors.Colors.black,
                                                      ),),
                                                    ],
                                                  ),
                                                ),
