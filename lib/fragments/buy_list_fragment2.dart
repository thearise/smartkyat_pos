...
//   @override
//   initState() {
//     // debugPrint('snapshots ' + widget.buyOrdersSnapshot.toString());
//     // debugPrint('snapshots ' + widget.merchantsSnapshot.toString());
...
//   //                                                               ),
//   //                                                               SizedBox(width: 4),
//   //                                                               Text(convertToHour(item.split('^')[7]) + ':' + convertToMinutes(item.split('^')[8]) + ' ' + convertToAMPM(item.split('^')[7]),
//   //                                                                 style: TextStyle(
//   //                                                                   fontSize: 14,
//   //                                                                   fontWeight: FontWeight.w500,
//   //                                                                   color: Colors.grey,
...
//         if(list[i].split('^')[4].toString() != 'FALSE') {
//           newList.add(list[i]);}
//       }
...
//
//                                           List<String> itemsList = [data21['deviceId'] + data21['orderId'] + '^' + data21['deviceId'] + data21['orderId'] + '^' + data21['total'].toString() + '^' + data21['merchantId'] + '^' + data21['refund'].toString() + '^' + data21['debt'].toString() + '^' + data21['discount'].toString() + '^' + data21['date'].toDate().hour.toString() + '^' + data21['date'].toDate().minute.toString()];
//
//                                           var section = ExampleSection()
