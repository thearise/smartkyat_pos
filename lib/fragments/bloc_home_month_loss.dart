...
//
// class BlocHomeMonthLoss extends StatefulWidget {
//
//   const BlocHomeMonthLoss({
//     Key? key,
...
//
//   @override
//   _BlocHomeMonthLossState createState() => _BlocHomeMonthLossState();
//
...
// }
//
// class _BlocHomeMonthLossState extends State<BlocHomeMonthLoss> {
...
//     for(int i = 0; i < loadedState.documentSnapshots.length; i++) {
//       Map<String, dynamic> dataL = loadedState.documentSnapshots[i].data()! as Map<String, dynamic>;
//       // totalLossPrice += dataL['amount'] * dataL['buy_price'];
//     }
//
//     debugPrint('totalLossPrice  ' + totalLossPrice.toString());
//
//     fetchOrdersMY(widget.sale);
...
//           debugPrint('George ' + data[today.year.toString() + zeroToTen(today.month.toString()) + zeroToTen(i.toString()) + 'loss_cust'].toString());
//         }
//       }
//
//       for(int i = 0; i< 32; i++) {
