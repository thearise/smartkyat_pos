...
//                                                 .doc(shopId)
//                                                 .collection('order')
//                                                 .where('customerId', isEqualTo: snapshot.data!.docs[index].id)
//                                                 .where('debt', isGreaterThan: 0)
//                                                 .snapshots(),
//                                             builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot2) {
//                                               if(snapshot2.hasData) {
//                                                 return cateScIndex == 0 || snapshot2.data!.docs.length > 0 ? GestureDetector(
//                                                   onTap: () {
//                                                     Navigator.push(
//                                                       context,
//                                                       MaterialPageRoute(
...
//                                                                     crossAxisAlignment: CrossAxisAlignment.start,
//                                                                     children: [
//                                                                       snapshot2.data!.docs.length > 0? Container(
//                                                                         height: 21,
//                                                                         decoration: BoxDecoration(
//                                                                           borderRadius: BorderRadius.circular(20.0),
//                                                                           color: AppTheme.badgeFgDanger,
