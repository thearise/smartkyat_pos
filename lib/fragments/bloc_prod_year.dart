...
class BlocProdYear extends StatefulWidget {
  ...
  @override
  _BlocProdYearState createState() => _BlocProdYearState();
...
class _BlocProdYearState extends State<BlocProdYear> {
  ...
  Widget _buildListView(PaginationLoaded loadedState) {
    ...
    debugPrint('bloc_fire prod year only ' + today.toString() + ' -- ' + loadedState.documentSnapshots.length.toString());
