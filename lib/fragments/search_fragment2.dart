...
// import 'package:smartkyat_pos/fragments/search_blocs/bloc/weather_bloc.dart';
// import 'package:smartkyat_pos/fragments/search_blocs/data/weather_repository.dart';
// import 'package:smartkyat_pos/fragments/search_blocs/pages/weather_search_page.dart';
...
// import 'search_blocs/products_bloc.dart';
//
...
//                   controller: _scrollController,
//                   slivers: [
//                     SliverList(delegate: SliverChildBuilderDelegate((context, index) {return Container();}, childCount: 1,),),
//                   ],
//                 );
//               }
//
...
//               if(cateScIndex == 1) {
//                 if(i1Clicked) {
//                   custs = sortMapByNaS(custs);
//                 } else {
//                   custs = sortMapByDeS(custs);
//                 }
//               }
//
//
...
//
//             if(mercsSB.hasData) {
//               var mercsSnapOut = mercsSB.data != null? mercsSB.data!.data(): null;
...
//               if(cateScIndex == 2) {
//                 if(i1Clicked) {
//                   mercs = sortMapByNaS(mercs);
//                 } else {
//                   mercs = sortMapByDeS(mercs);
//                 }
//               }
//
//
