                                            ...
                                            children: [
                                                  ...
                                                  children: [
                                                    ...
                                                    Expanded(
                                                      child: GestureDetector(
                                                                ...
                                                                await FirebaseFirestore.instance.collection('shops')
                                                                  ...
                                                                  if(userData['plan_type'] == 'basic' && shopCount >= 5) {
                                                                    ...
                                                                    Navigator.push(
                                                                      context,
                                                                      MaterialPageRoute(
                                                                          builder: (context) => AddShop(isEnglish: isEnglish)),
                                                                    );
                                                                  }
                                                                });
                                                              });
                                                        ...
                                                        child: createLoadingState == false ? Container(
                                                          child: Row(
                                                            crossAxisAlignment: CrossAxisAlignment.center,
                                                            mainAxisAlignment: MainAxisAlignment.center,
                                                            children: [
                                                              Text(isEnglish? 'Create new shop': 'ဆိုင်အသစ် ထည့်ရန်', textScaleFactor: 1,
                                              ...
                                              RichText(
                                                ...
                                                text: new TextSpan(
                                                  children: [
                                                    new TextSpan(
                                                      text: isEnglish? 'Set up some information about your shop later in shop settings.': 'ဆိုင်နှင့်ပတ်သက်ပြီး အချက်အလက်အချို့ကို နောက်ပြီးပြန်လည် ပြင်ဆိုင်နိုင်ပါသည်။',
                                                      style: new TextStyle(
                                                        fontSize: 12.5,
                                                        color: Colors.grey,
                                                        fontWeight: FontWeight.w500,
                                                    ...
                                                    _result != null? ButtonTheme(
                                                      ...
                                                      child: FlatButton(
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: Container(
                                                            child: Text(
                                                              isEnglish? 'Logout': 'ထွက်မည်', textScaleFactor: 1,
                                                      ...
                                                      child: ButtonTheme(
                                                        ...
                                                        child: FlatButton(
                                                                  ...
                                                                  // .where('date', isGreaterThanOrEqualTo: todayToYearStart(now))
                                                                    ...
                                                                    if(!(startDate.isBefore(nowCheck) && endDate.isAfter(nowCheck))) {
                                                                      Future.delayed(const Duration(milliseconds: 500), () {
                                                                        // smartKyatFMod(context, '$shopName shop pro version ended', 'e');
                                                                        setState(() {
                                                                          loadingState = false;
                                                                          disableTouch = false;
                                                                        });
                                                                        premiumCart(_result, shopName);
                                                                      });
                                                                    } else {
                                                                                        ...
                                                                                        cntQuery.docs.forEach((doc) {
                                                                                          ...
                                                                                          if(loop == 4) {
                                                                                            ...
                                                                                            if(cntColFetch.contains('') || cntColFetch.contains('null')) {
                                                                                              smartKyatFMod(context, 'Something went wrong. Please try again later', 'e');
                                                                                              setState(() {
                                                                                                loadingState = false;
                                                                                                disableTouch = false;
                                                                                              });
                                                          ...
                                                          child:  loadingState? Theme(data: ThemeData(cupertinoOverrideTheme: CupertinoThemeData(brightness: Brightness.light)),
                                                            ...
                                                            child: Container(
                                                              child: Text(
                                                                isEnglish? 'Go to dashboard': 'ဝင်ရောက်မည်', textScaleFactor: 1,
                                                                textAlign: TextAlign.center,
                                                                style: TextStyle(
                                                                    height: 1.3,
                                                                    fontSize: 17.5,
                                                    ...
                                                    child: GestureDetector(
                                                      ...
                                                      child: createLoadingState == false  ? Container(
                                                        child: Row(
                                                          ...
                                                          mainAxisAlignment: MainAxisAlignment.center,
                                                          children: [
                                                            Text(isEnglish? 'Create new shop': 'ဆိုင်အသစ်ထည့်ရန်', textScaleFactor: 1,
                                                              style: TextStyle(color: Colors.blue, fontWeight: FontWeight.w500, fontSize: 15),
                                                              strutStyle: StrutStyle(
                                                                height: 1.2,
                                                                // fontSize:,
