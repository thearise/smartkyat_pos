...
import 'order_refund_sub_off.dart';
...
class OrderInfoSub extends StatefulWidget {
  ...
  const OrderInfoSub(
  {Key? key, required this.data, required this.isEnglish,  required this.shopId,required void toggleCoinCallback(), required this.fromSearch, this.selectedDev, required void printFromOrders(File file, var prodListPR)})
...
class _OrderInfoSubState extends State<OrderInfoSub>
  ...
  initState() {
    ...
    docId = (widget.data.split('^')[1]).toString();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: IgnorePointer(
        ...
        //     top: true,
        //     bottom: true,
        //     child: StreamBuilder<SaleOrder?>(
        //       stream: objectbox.getOrder(int.parse(widget.data.split('^')[1])),
        //       builder: (context, snapshot) {
        //         if(snapshot.data!=null) {
        //           return StreamBuilder<List<OrdProd>>(
        //             stream: objectbox.getOrdProds(int.parse(widget.data.split('^')[1])),
        //             builder: (context, snapOrdProd) {
        //               if(snapOrdProd.data!=null) {
        //                 SaleOrder saleOrder = snapshot.data ?? SaleOrder(
        //                     0,0,0,0,false,0,''
        //                 );
        //                 var output1;
        //
        //
        //                 if(saleOrder.ordProds == null) {
        ...
        //
        //
        //                 List<OrdProd> prodListObj = snapOrdProd.data ?? [];
        //                 List<String> prodList = [];
        //                 debugPrint('phyophyo2 ' + prodListObj[0].name.toString());
        //                 for (int i=0; i < prodListObj.length; i++) {
        //                   prodList.add(
        //                       prodListObj[i].id.toString() + '^' +
        //                           prodListObj[i].name + '^' +
        //                           prodListObj[i].text.toString() + '^' +
        //                           prodListObj[i].quantity.toString() + '^' +
        //                           prodListObj[i].sale.toString() + '^' +
        //                           prodListObj[i].uname.toString() + '^' +
        //                           prodListObj[i].buy.toString() + '^' +
        //                           prodListObj[i].refquant.toString() + '^'
        //                   );
        //                   debugPrint('offline prodlist ' + prodListObj[i].uname + ' --> ' + prodListObj[i].text);
        //                 }
        //
        //                 var debt = saleOrder.debt;
        //                 var documentId = saleOrder.id;
        //                 var dateOrg = saleOrder.date;
        //                 prodListView = [];
