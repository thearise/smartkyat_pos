        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.stretch,
            ...
            children: [
              ...
              Padding(
                ...
                child: Text('CURRENT SHOPP', style: TextStyle(
                  letterSpacing: 1.5,
              ...
              SizedBox(height: 15,),
              Padding(
                padding: const EdgeInsets.only(left: 15.0, right: 15.0, top: 4.0, bottom: 15.0),
                child: Container(
                  child: TextFormField(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: (){
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => switchShop()),
                              );
                            },
                            child: Padding(
                                ...
                                child: Center(
                                  child: ListTile(
                                    ...
                                    trailing: Row(
                                      ...
                                      children: [
                                        Text('Ethereal shops' ,style: TextStyle(fontSize: 17, fontWeight: FontWeight.w500,color: Colors.grey),),
                                        SizedBox(width: 8,),
                                        Icon(
                                          Icons
